...
const props = defineProps({
    ...
    color: {
        ...
        validator: (value) => ['gray', 'red', 'green', 'yellow', 'teal', 'blue', 'indigo', 'purple', 'pink','orange'].includes(value), // Validador de colores
    },
    padding: {
        type: String,
...
const colorClasses = computed(() => {
    ...
    const colorMap = {
        ...
        yellow: 'bg-yellow-600 hover:bg-yellow-500 focus:bg-yellow-500 active:bg-yellow-700 focus:ring-yellow-300 disabled:opacity-50 disabled:cursor-not-allowed',
        ...
        orange: 'bg-orange-600 hover:bg-orange-500 focus:bg-orange-500 active:bg-orange-700 focus:ring-orange-300 disabled:opacity-50 disabled:cursor-not-allowed',
    };
